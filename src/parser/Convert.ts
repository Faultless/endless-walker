...
const typeMap: any = {
    "Coordinate": o([
        ...
        },
        {
            json: "worldLayout",
            js: "worldLayout",
            typ: u(undefined, u(r("WorldLayout"), null)),
        },
    ...
    "ForcedRefs": o([
        {
            ...
            typ: u(undefined, r("AutoLayerRuleGroup")),
        },
        {
            json: "AutoRuleDef",
            js: "AutoRuleDef",
            typ: u(undefined, r("AutoLayerRuleDefinition")),
        },
        {
            json: "CustomCommand",
            js: "CustomCommand",
            typ: u(undefined, r("LdtkCustomCommand")),
        },
        {
            json: "Definitions",
            js: "Definitions",
            typ: u(undefined, r("Definitions")),
        },
        {
            json: "EntityDef",
            js: "EntityDef",
            typ: u(undefined, r("EntityDefinition")),
        },
        {
            json: "EntityInstance",
            js: "EntityInstance",
            typ: u(undefined, r("EntityInstance")),
        },
        {
            json: "EntityReferenceInfos",
            js: "EntityReferenceInfos",
            typ: u(undefined, r("ReferenceToAnEntityInstance")),
        },
        {
            json: "EnumDef",
            js: "EnumDef",
            typ: u(undefined, r("EnumDefinition")),
        },
        {
            json: "EnumDefValues",
            js: "EnumDefValues",
            typ: u(undefined, r("EnumValueDefinition")),
        },
        {
            json: "EnumTagValue",
            js: "EnumTagValue",
            typ: u(undefined, r("EnumTagValue")),
        },
        {
            json: "FieldDef",
            js: "FieldDef",
            typ: u(undefined, r("FieldDefinition")),
        },
        {
            json: "FieldInstance",
            js: "FieldInstance",
            typ: u(undefined, r("FieldInstance")),
        },
        {
            json: "GridPoint",
            js: "GridPoint",
            typ: u(undefined, r("GridPoint")),
        },
        {
            json: "IntGridValueDef",
            js: "IntGridValueDef",
            typ: u(undefined, r("IntGridValueDefinition")),
        },
        {
            json: "IntGridValueGroupDef",
            js: "IntGridValueGroupDef",
            typ: u(undefined, r("IntGridValueGroupDefinition")),
        },
        {
            json: "IntGridValueInstance",
            js: "IntGridValueInstance",
            typ: u(undefined, r("IntGridValueInstance")),
        },
        {
            json: "LayerDef",
            js: "LayerDef",
            typ: u(undefined, r("LayerDefinition")),
        },
        {
            json: "LayerInstance",
            js: "LayerInstance",
            typ: u(undefined, r("LayerInstance")),
        },
        { json: "Level", js: "Level", typ: u(undefined, r("Level")) },
        {
            json: "LevelBgPosInfos",
            js: "LevelBgPosInfos",
            typ: u(undefined, r("LevelBackgroundPosition")),
        },
        {
            json: "NeighbourLevel",
            js: "NeighbourLevel",
            typ: u(undefined, r("NeighbourLevel")),
        },
        {
            json: "TableOfContentEntry",
            js: "TableOfContentEntry",
            typ: u(undefined, r("LdtkTableOfContentEntry")),
        },
        { json: "Tile", js: "Tile", typ: u(undefined, r("TileInstance")) },
        {
            json: "TileCustomMetadata",
            js: "TileCustomMetadata",
            typ: u(undefined, r("TileCustomMetadata")),
        },
        {
            json: "TilesetDef",
            js: "TilesetDef",
            typ: u(undefined, r("TilesetDefinition")),
        },
        {
            json: "TilesetRect",
            js: "TilesetRect",
            typ: u(undefined, r("TilesetRectangle")),
        },
        {
            json: "TocInstanceData",
            js: "TocInstanceData",
            typ: u(undefined, r("LdtkTocInstanceData")),
        },
    ...
    "AutoLayerRuleGroup": o([
        ...
        { json: "color", js: "color", typ: u(undefined, u(null, "")) },
        {
            json: "icon",
            js: "icon",
            typ: u(undefined, u(r("TilesetRectangle"), null)),
        },
    ...
    "FieldDefinition": o([
        ...
        { json: "symmetricalRef", js: "symmetricalRef", typ: true },
        {
            ...
            js: "textLanguageMode",
            typ: u(undefined, u(r("TextLanguageMode"), null)),
        },
    ...
    "LayerDefinition": o([
        ...
        },
        {
            ...
            typ: a(r("IntGridValueGroupDefinition")),
        },
    ...
    "TilesetDefinition": o([
        ...
        },
        {
            json: "embedAtlas",
            js: "embedAtlas",
            typ: u(undefined, u(r("EmbedAtlas"), null)),
        },
    ...
    "LayerInstance": o([
        ...
        { json: "iid", js: "iid", typ: "" },
        {
            json: "intGrid",
            js: "intGrid",
            typ: u(undefined, u(a(r("IntGridValueInstance")), null)),
        },
    ...
    "Level": o([
        { json: "__bgColor", js: "__bgColor", typ: "" },
        {
            json: "__bgPos",
            js: "__bgPos",
            typ: u(undefined, u(r("LevelBackgroundPosition"), null)),
        },
        {
            json: "__neighbours",
            js: "__neighbours",
        ...
        { json: "iid", js: "iid", typ: "" },
        {
            json: "layerInstances",
            js: "layerInstances",
            typ: u(undefined, u(a(r("LayerInstance")), null)),
        },
        { json: "pxHei", js: "pxHei", typ: 0 },
        { json: "pxWid", js: "pxWid", typ: 0 },
        { json: "uid", js: "uid", typ: 0 },
    ...
    "LdtkTableOfContentEntry": o([
        { json: "identifier", js: "identifier", typ: "" },
        {
            json: "instances",
            js: "instances",
            typ: u(undefined, a(r("ReferenceToAnEntityInstance"))),
        },
        {
            json: "instancesData",
            js: "instancesData",
            typ: a(r("LdtkTocInstanceData")),
        },
    ], false),
